...
#       Version: $Revision: 1.0 $  Dated: $Date: 2013/09/27 14:00:00 $           #
#                                                                                #
# ============================================================================== #
...
def main():
    ...
    cmd_str = "rwh45 %s %s %s %s %s %s -l %s %s %s %s" % (config_file, rwh_begin_time_string, rwh_end_time_string, fcst_road_seg_file, vdt_road_seg_file, output_path, options.log, road_wx_opt_str, road_cond_opt_str, seg_stats_opt_str)

...
input_dirs = "%s %s %s %s" % ("None", Bridge_cond_init_dir, Obs_hist_dir, Rdwx_fcst_dir)

age = "86400 86400 86400 86400"

output_dir = "%s/%s" %  (rctm_path.Rctm_root_dir, "bc_no_tmt")

log_base = "%s/%s" % (rctm_path.Log_dir, "bc_no_tmt")

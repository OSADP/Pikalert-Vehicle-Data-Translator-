...
# Runs roadcond_mdss for bridges with the recommended-treatment option.
...
output_dir = "%s/%s" %  (rctm_path.Rctm_root_dir, "bc_rec_tmt")

log_base = "%s/%s" % (rctm_path.Log_dir, "bc_rec_tmt")

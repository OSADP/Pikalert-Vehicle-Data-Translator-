...
# Runs roadcond_mdss with the no-treatment option.
...
input_dirs = "%s %s %s %s" % ("None", Road_cond_init_dir, Obs_hist_dir, Rdwx_fcst_dir)

age = "86400 86400 86400 86400"

output_dir = "%s/%s" %  (rctm_path.Rctm_root_dir, "rc_no_tmt")

log_base = "%s/%s" % (rctm_path.Log_dir, "rc_no_tmt")

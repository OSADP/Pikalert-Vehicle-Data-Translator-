...
Colorado_road_segments_file = os.path.join(cdl_dir, "co_roads.20150820.nc")
...
Colorado_radius = 1000

Product_dictionary_vdt = {"road_wx_dir" : fhwa_rdwx_logicast_dir, "rec_treatment" : fhwa_logicast_tmt_dir, "district_alerts" : Colorado_district_alerts_dir, "latest_vehicles" : Colorado_latest_vehicles_dir}
Colorado_vdt = StateData(State, All_sites_file, Road_cond_sites_file, Wx_obs_sites_file, Rwis_sites_file, Rwis_sites_var_file, fhwa_rdwx_logicast_dir, rdwx_base_name, fhwa_logicast_tmt_dir, tmt_base_name, fhwa_wx_obs_dir, fhwa_mesonet_dir, Districts, Product_dictionary_vdt, Met_vars, Colorado_output_dir, Colorado_district_alerts_dir, Colorado_latest_vehicles_dir, Colorado_vdt_plots_dir, Colorado_rwh_dir, Colorado_obs_stats_dir, Colorado_obs_stats_json_dir, Colorado_maw_json_dir, Colorado_nearest_neighbor_files, Colorado_road_segments_file, Colorado_timezone, Colorado_radius)

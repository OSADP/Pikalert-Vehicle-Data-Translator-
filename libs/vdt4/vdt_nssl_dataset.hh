...
public:
   ...
   */
  virtual int get_reflectivity(float lat, float lon, float& v, int& x, int& y) = 0;
  virtual ~vdt_radar_dataset(){}
};

/**
 * @class vdt_nssl_radar_dataset2
 * VDT NSSL (National Severe Storms Laboratory) radar dataset class Version 2 (GRIB)
 */
class vdt_nssl_radar_dataset2 : public vdt_radar_dataset
{

public:
  /** @brief nssl radar netcdf latitude grid spacing */
  static const float NSSL_RADAR_LATITUDE_GRID_SPACING;

  /** @brief nssl radar netcdf longitude grid spacing */
  static const float NSSL_RADAR_LONGITUDE_GRID_SPACING;

  static const float NSSL_RADAR_NW_LATITUDE;

  static const float NSSL_RADAR_NW_LONGITUDE;
   ...
   */
  vdt_nssl_radar_dataset2(const char* filename, Log* logg = NULL);
   ...
   */
  vdt_nssl_radar_dataset2(const vdt_nssl_radar_dataset2& o);
  ~vdt_nssl_radar_dataset2();
 ...
 * VDT NSSL (National Severe Storms Laboratory) radar dataset class (Original MRMS binary)
 */
class vdt_nssl_radar_dataset : public vdt_radar_dataset
{
 ...
 */
class vdt_nssl_tiled_radar_dataset : public vdt_radar_dataset
{
...
public:
   ...
   * @param[in] lon  longitude
   * @param[out] v   composite reflectivitiy value
   * @param[out] x   x coord of radar grid
   * @param[out] y   y coord of radar grid
   * @return 0 on success, -1 on failure
   */
  int get_reflectivity(float lat, float lon, float& v, int& x, int& y);

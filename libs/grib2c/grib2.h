...
#define G2_VERSION "g2clib-1.2.1"
/*                .      .    .                                       .
...
// Define prototypes when this file is included from C++ compiler
// Jim Cowie/RAL 11/05/10

#ifdef __cplusplus

/*  Prototypes for unpacking API  */
extern "C" void seekgb(FILE *,g2int ,g2int ,g2int *,g2int *);
extern "C" g2int g2_info(unsigned char *,g2int *,g2int *,g2int *,g2int *);
extern "C" g2int g2_getfld(unsigned char *,g2int ,g2int ,g2int ,gribfield **);
extern "C" void g2_free(gribfield *);
/*  Prototypes for packing API  */
extern "C" g2int g2_create(unsigned char *,g2int *,g2int *);
extern "C" g2int g2_addlocal(unsigned char *,unsigned char *,g2int );
extern "C" g2int g2_addgrid(unsigned char *,g2int *,g2int *,g2int *,g2int );
extern "C" g2int g2_addfield(unsigned char *,g2int ,g2int *,
                       g2float *,g2int ,g2int ,g2int *,
                       g2float *,g2int ,g2int ,g2int *);
extern "C" g2int g2_gribend(unsigned char *);

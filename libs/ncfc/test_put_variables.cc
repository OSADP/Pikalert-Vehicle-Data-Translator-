...
//
// Description:
//     Sample code illustrating NCFC_put_variables() in ncfc
//----------------------------------------------------------------------
...
void usage(char *prog_name)
{
  ...
  fprintf(stderr, "For examples: test_put_variables -c test_put_variables.cdl test.nc\n");
}
...
int main(int argc, char **argv)
{
  ...
  enum Var_names {MARK, TIME, LATITUDE, LONGITUDE, TEMPERATURE, STATIONS, QPF};
  ...
  signed char *qpf = (signed char *)var_ptrs[QPF];
  float x = 127.0;

...
/**
 * @file rwx_ak_rtma_dataset.hh
 *
 * @class rwx_ak_rtma_dataset
 *
 * @date 10/24/13
 */


#ifndef RWX_AK_RTMA_DATASET_HH
#define RWX_AK_RTMA_DATASET_HH
...
typedef struct rwx_ak_rtma_proj_info
{
  double latin;
  double lov;
  double lad;
...
public:
   ...
   */
  rwx_ak_rtma_dataset(const std::string &input_file_arg, const rwx_ak_rtma_proj_info_t &proj_info);

...
int CharacterizeStorm( RoadConditions *roadfcst, WxForecast *wxfcst, StormType *stormType, int num_rc_times )
{
  ...
  proc_log->write_time(4, "Final storm cold bs score: %4.2f\n",stormType->ColdBS_score);
  ...
  proc_log->write_time( 4, "Final road trend type: %d (weight = %4.2f)\n",FinalType, maxScore);

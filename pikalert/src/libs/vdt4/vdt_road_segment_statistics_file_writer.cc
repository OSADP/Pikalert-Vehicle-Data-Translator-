...
const char* vdt_road_segment_statistics_file_writer::ROAD_SEGMENT_ID = "road_segment_id";
const char* vdt_road_segment_statistics_file_writer::TOTAL_NUM_MSG = "total_num_msg";

const char* vdt_road_segment_statistics_file_writer::MODEL_AIR_TEMP = "model_air_temp";
const char* vdt_road_segment_statistics_file_writer::MODEL_DEWPOINT = "model_dewpoint";
const char* vdt_road_segment_statistics_file_writer::MODEL_BAR_PRESS = "model_bar_press";
const char* vdt_road_segment_statistics_file_writer::RADAR_REF = "radar_ref";
const char* vdt_road_segment_statistics_file_writer::RADAR_PRECIP_FLAG = "radar_precip_flag";
const char* vdt_road_segment_statistics_file_writer::RADAR_PRECIP_TYPE = "radar_precip_type";
const char* vdt_road_segment_statistics_file_writer::CLOUD_MASK = "cloud_mask";
const char* vdt_road_segment_statistics_file_writer::NSS_AIR_TEMP_MEAN = "nss_air_temp_mean";
const char* vdt_road_segment_statistics_file_writer::NSS_BAR_PRESS_MEAN = "nss_bar_press_mean";
const char* vdt_road_segment_statistics_file_writer::NSS_DEW_TEMP_MEAN = "nss_dew_temp_mean";
const char* vdt_road_segment_statistics_file_writer::NSS_WIND_DIR_MEAN = "nss_wind_dir_mean";
const char* vdt_road_segment_statistics_file_writer::NSS_WIND_SPEED_MEAN = "nss_wind_speed_mean";
const char* vdt_road_segment_statistics_file_writer::NSS_HOURLY_PRECIP_MEAN = "nss_hourly_precip_mean";
const char* vdt_road_segment_statistics_file_writer::NSS_PREVAIL_VIS_MEAN = "nss_prevail_vis_mean";

const char* vdt_road_segment_statistics_file_writer::NUM_MSG_VALID_AIR_TEMP = "num_msg_valid_air_temp";
const char* vdt_road_segment_statistics_file_writer::AIR_TEMP_MIN = "air_temp_min";
const char* vdt_road_segment_statistics_file_writer::AIR_TEMP_MAX = "air_temp_max";
const char* vdt_road_segment_statistics_file_writer::AIR_TEMP_MEAN = "air_temp_mean";
const char* vdt_road_segment_statistics_file_writer::AIR_TEMP_MEDIAN = "air_temp_median";
const char* vdt_road_segment_statistics_file_writer::AIR_TEMP_VAR = "air_temp_var";
const char* vdt_road_segment_statistics_file_writer::AIR_TEMP_STDEV = "air_temp_stdev";

const char* vdt_road_segment_statistics_file_writer::NUM_MSG_VALID_AIR_TEMP2 = "num_msg_valid_air_temp2";
const char* vdt_road_segment_statistics_file_writer::AIR_TEMP2_MIN = "air_temp2_min";
const char* vdt_road_segment_statistics_file_writer::AIR_TEMP2_MAX = "air_temp2_max";
const char* vdt_road_segment_statistics_file_writer::AIR_TEMP2_MEAN = "air_temp2_mean";
const char* vdt_road_segment_statistics_file_writer::AIR_TEMP2_MEDIAN = "air_temp2_median";
const char* vdt_road_segment_statistics_file_writer::AIR_TEMP2_VAR = "air_temp2_var";
const char* vdt_road_segment_statistics_file_writer::AIR_TEMP2_STDEV = "air_temp2_stdev";

const char* vdt_road_segment_statistics_file_writer::NUM_MSG_VALID_BAR_PRESS = "num_msg_valid_bar_press";
const char* vdt_road_segment_statistics_file_writer::BAR_PRESS_MIN = "bar_press_min";
const char* vdt_road_segment_statistics_file_writer::BAR_PRESS_MAX = "bar_press_max";
const char* vdt_road_segment_statistics_file_writer::BAR_PRESS_MEAN = "bar_press_mean";
const char* vdt_road_segment_statistics_file_writer::BAR_PRESS_MEDIAN = "bar_press_median";
const char* vdt_road_segment_statistics_file_writer::BAR_PRESS_VAR = "bar_press_var";
const char* vdt_road_segment_statistics_file_writer::BAR_PRESS_STDEV = "bar_press_stdev";

const char* vdt_road_segment_statistics_file_writer::NUM_MSG_VALID_DEW_TEMP = "num_msg_valid_dew_temp";
const char* vdt_road_segment_statistics_file_writer::DEW_TEMP_MIN = "dew_temp_min";
const char* vdt_road_segment_statistics_file_writer::DEW_TEMP_MAX = "dew_temp_max";
const char* vdt_road_segment_statistics_file_writer::DEW_TEMP_MEAN = "dew_temp_mean";
const char* vdt_road_segment_statistics_file_writer::DEW_TEMP_MEDIAN = "dew_temp_median";
const char* vdt_road_segment_statistics_file_writer::DEW_TEMP_VAR = "dew_temp_var";
const char* vdt_road_segment_statistics_file_writer::DEW_TEMP_STDEV = "dew_temp_stdev";

const char* vdt_road_segment_statistics_file_writer::NUM_MSG_VALID_HEADING = "num_msg_valid_heading";
const char* vdt_road_segment_statistics_file_writer::HEADING_MIN = "heading_min";
const char* vdt_road_segment_statistics_file_writer::HEADING_MAX = "heading_max";
const char* vdt_road_segment_statistics_file_writer::HEADING_MEAN = "heading_mean";
const char* vdt_road_segment_statistics_file_writer::HEADING_MEDIAN = "heading_median";
const char* vdt_road_segment_statistics_file_writer::HEADING_VAR = "heading_var";
const char* vdt_road_segment_statistics_file_writer::HEADING_STDEV = "heading_stdev";

const char* vdt_road_segment_statistics_file_writer::NUM_MSG_VALID_LAT_ACCEL = "num_msg_valid_hoz_accel_lat";
const char* vdt_road_segment_statistics_file_writer::LAT_ACCEL_MIN = "hoz_accel_lat_min";
const char* vdt_road_segment_statistics_file_writer::LAT_ACCEL_MAX = "hoz_accel_lat_max";
const char* vdt_road_segment_statistics_file_writer::LAT_ACCEL_MEAN = "hoz_accel_lat_mean";
const char* vdt_road_segment_statistics_file_writer::LAT_ACCEL_MEDIAN = "heading_median";
const char* vdt_road_segment_statistics_file_writer::LAT_ACCEL_VAR = "heading_var";
const char* vdt_road_segment_statistics_file_writer::LAT_ACCEL_STDEV = "heading_stdev";

const char* vdt_road_segment_statistics_file_writer::NUM_MSG_VALID_LON_ACCEL = "num_msg_valid_hoz_accel_lat";
const char* vdt_road_segment_statistics_file_writer::LON_ACCEL_MIN = "hoz_accel_lat_min";
const char* vdt_road_segment_statistics_file_writer::LON_ACCEL_MAX = "hoz_accel_lat_max";
const char* vdt_road_segment_statistics_file_writer::LON_ACCEL_MEAN = "hoz_accel_lat_mean";
const char* vdt_road_segment_statistics_file_writer::LON_ACCEL_MEDIAN = "hoz_accel_lat_median";
const char* vdt_road_segment_statistics_file_writer::LON_ACCEL_VAR = "hoz_accel_lat_var";
const char* vdt_road_segment_statistics_file_writer::LON_ACCEL_STDEV = "hoz_accel_lat_stdev";

const char* vdt_road_segment_statistics_file_writer::NUM_MSG_VALID_YAW = "num_msg_valid_hoz_accel_lat";
const char* vdt_road_segment_statistics_file_writer::YAW_MIN = "hoz_accel_lat_min";
const char* vdt_road_segment_statistics_file_writer::YAW_MAX = "hoz_accel_lat_max";
const char* vdt_road_segment_statistics_file_writer::YAW_MEAN = "hoz_accel_lat_mean";
const char* vdt_road_segment_statistics_file_writer::YAW_MEDIAN = "hoz_accel_lat_median";
const char* vdt_road_segment_statistics_file_writer::YAW_VAR = "hoz_accel_lat_var";
const char* vdt_road_segment_statistics_file_writer::YAW_STDEV = "hoz_accel_lat_stdev";

const char* vdt_road_segment_statistics_file_writer::NUM_MSG_VALID_STEERING_ANGLE = "num_msg_valid_hoz_accel_lat";
const char* vdt_road_segment_statistics_file_writer::STEERING_ANGLE_MIN = "hoz_accel_lat_min";
const char* vdt_road_segment_statistics_file_writer::STEERING_ANGLE_MAX = "hoz_accel_lat_max";
const char* vdt_road_segment_statistics_file_writer::STEERING_ANGLE_MEAN = "hoz_accel_lat_mean";
const char* vdt_road_segment_statistics_file_writer::STEERING_ANGLE_MEDIAN = "hoz_accel_lat_median";
const char* vdt_road_segment_statistics_file_writer::STEERING_ANGLE_VAR = "hoz_accel_lat_var";
const char* vdt_road_segment_statistics_file_writer::STEERING_ANGLE_STDEV = "hoz_accel_lat_stdev";

const char* vdt_road_segment_statistics_file_writer::NUM_MSG_VALID_LIGHTS = "num_msg_valid_lights";
const char* vdt_road_segment_statistics_file_writer::NUM_LIGHTS_OFF = "num_lights_off";
const char* vdt_road_segment_statistics_file_writer::NUM_LIGHTS_HAZARD = "num_lights_hazard";
const char* vdt_road_segment_statistics_file_writer::NUM_LIGHTS_PARKING = "num_lights_parking";
const char* vdt_road_segment_statistics_file_writer::NUM_LIGHTS_FOG = "num_lights_fog";
const char* vdt_road_segment_statistics_file_writer::NUM_LIGHTS_DRL = "num_lights_drl";
const char* vdt_road_segment_statistics_file_writer::NUM_LIGHTS_AUTOMATIC_CONTROL = "num_lights_automatic_control";
const char* vdt_road_segment_statistics_file_writer::NUM_LIGHTS_RIGHT_TURN = "num_lights_right_turn";
const char* vdt_road_segment_statistics_file_writer::NUM_LIGHTS_LEFT_TURN = "num_lights_left_turn";
const char* vdt_road_segment_statistics_file_writer::NUM_LIGHTS_HIGH_BEAM = "num_lights_high_beam";
const char* vdt_road_segment_statistics_file_writer::NUM_LIGHTS_LOW_BEAM = "num_lights_low_beam";

const char* vdt_road_segment_statistics_file_writer::NUM_MSG_VALID_SPEED = "num_msg_valid_speed";
const char* vdt_road_segment_statistics_file_writer::SPEED_RATIO = "speed_ratio";
const char* vdt_road_segment_statistics_file_writer::SPEED_MIN = "speed_min";
const char* vdt_road_segment_statistics_file_writer::SPEED_MAX = "speed_max";
const char* vdt_road_segment_statistics_file_writer::SPEED_MEAN = "speed_mean";
const char* vdt_road_segment_statistics_file_writer::SPEED_MEDIAN = "speed_median";
const char* vdt_road_segment_statistics_file_writer::SPEED_VAR = "speed_var";
const char* vdt_road_segment_statistics_file_writer::SPEED_STDEV = "speed_stdev";

const char* vdt_road_segment_statistics_file_writer::NUM_MSG_VALID_SURFACE_TEMP = "num_msg_valid_surface_temp";
const char* vdt_road_segment_statistics_file_writer::SURFACE_TEMP_MIN = "surface_temp_min";
const char* vdt_road_segment_statistics_file_writer::SURFACE_TEMP_MAX = "surface_temp_max";
const char* vdt_road_segment_statistics_file_writer::SURFACE_TEMP_MEAN = "surface_temp_mean";
const char* vdt_road_segment_statistics_file_writer::SURFACE_TEMP_MEDIAN = "surface_temp_median";
const char* vdt_road_segment_statistics_file_writer::SURFACE_TEMP_VAR = "surface_temp_var";
const char* vdt_road_segment_statistics_file_writer::SURFACE_TEMP_STDEV = "surface_temp_stdev";

const char* vdt_road_segment_statistics_file_writer::NUM_MSG_VALID_WIPERS = "num_msg_valid_wipers";
const char* vdt_road_segment_statistics_file_writer::NUM_WIPERS_NOT_EQUIPPED = "num_wipers_not_equipped";
const char* vdt_road_segment_statistics_file_writer::NUM_WIPERS_OFF = "num_wipers_off";
const char* vdt_road_segment_statistics_file_writer::NUM_WIPERS_INTERMITTENT = "num_wipers_intermittent";
const char* vdt_road_segment_statistics_file_writer::NUM_WIPERS_LOW = "num_wipers_low";
const char* vdt_road_segment_statistics_file_writer::NUM_WIPERS_HIGH = "num_wipers_high";
const char* vdt_road_segment_statistics_file_writer::NUM_WIPERS_WASHER = "num_wipers_washer";
const char* vdt_road_segment_statistics_file_writer::NUM_WIPERS_AUTOMATIC = "num_wipers_automatic";

const char* vdt_road_segment_statistics_file_writer::NUM_MSG_VALID_ABS = "num_msg_valid_abs";
const char* vdt_road_segment_statistics_file_writer::NUM_ABS_NOT_EQUIPPED = "num_abs_not_equipped";
const char* vdt_road_segment_statistics_file_writer::NUM_ABS_OFF = "num_abs_off";
const char* vdt_road_segment_statistics_file_writer::NUM_ABS_ON = "num_abs_on";
const char* vdt_road_segment_statistics_file_writer::NUM_ABS_ENGAGED = "num_abs_engaged";

const char* vdt_road_segment_statistics_file_writer::NUM_MSG_VALID_STAB = "num_msg_valid_stab";
const char* vdt_road_segment_statistics_file_writer::NUM_STAB_NOT_EQUIPPED = "num_stab_not_equipped";
const char* vdt_road_segment_statistics_file_writer::NUM_STAB_OFF = "num_stab_off";
const char* vdt_road_segment_statistics_file_writer::NUM_STAB_ON = "num_stab_on";
const char* vdt_road_segment_statistics_file_writer::NUM_STAB_ENGAGED = "num_stab_engaged";

const char* vdt_road_segment_statistics_file_writer::NUM_MSG_VALID_TRAC = "num_msg_valid_trac";
const char* vdt_road_segment_statistics_file_writer::NUM_TRAC_NOT_EQUIPPED = "num_trac_not_equipped";
const char* vdt_road_segment_statistics_file_writer::NUM_TRAC_OFF = "num_trac_off";
const char* vdt_road_segment_statistics_file_writer::NUM_TRAC_ON = "num_trac_on";
const char* vdt_road_segment_statistics_file_writer::NUM_TRAC_ENGAGED = "num_trac_engaged";

vdt_road_segment_statistics_file_writer::vdt_road_segment_statistics_file_writer(const char* fpath, const char* cdl) : vdt_nc_file_writer(fpath,cdl)
{
}
...
{
  NcVar* seg_id_var = nc->get_var(ROAD_SEGMENT_ID);

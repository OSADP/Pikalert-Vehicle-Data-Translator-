...
//       All rights reserved.
//
//       File: $RCSfile: vdt_probe_message_qc_statistics_file_writer.hh,v $
//       Version: $Revision: 1.4 $  Dated: $Date: 2014/04/08 17:05:52 $
//
//==============================================================================

/**
 *
 * @file vdt_probe_message_qc_statistics_file_writer.hh
 *
 * @class vdt_probe_message_qc_statistics_file_writer
 *
...
#ifndef VDT_PROBE_MESSAGE_QC_STATISTICS_FILE_WRITER_HH
#define VDT_PROBE_MESSAGE_QC_STATISTICS_FILE_WRITER_HH
 ...
 */
class vdt_probe_message_qc_statistics_file_writer : public vdt_nc_file_writer
{

public:

  /** @brief road segment id netcdf variable name */
  static const char* PROBE_MESSAGE_QC_ID;

  /** @brief begin time of statistics time interval */
  static const char* BEGIN_TIME;

  /** @brief end time of statistics time interval */
  ...
  /** @brief 25th percentile air temperature netcdf variable name */
  static const char* AIR_TEMP_IQR25;

  /** @brief 75th percentile air temperature netcdf variable name */
  static const char* AIR_TEMP_IQR75;
  ...
  /** @brief 25th percentile external air temperature netcdf variable name */
  static const char* AIR_TEMP2_IQR25;

  /** @brief 75th percentile external air temperature netcdf variable name */
  static const char* AIR_TEMP2_IQR75;
  ...
  /** @brief 25th percentile barometric pressure netcdf variable name */
  static const char* BAR_PRESS_IQR25;

  /** @brief 75th percentile barometric pressure netcdf variable name */
  static const char* BAR_PRESS_IQR75;
  ...
  /** @brief 25th percentile dew temperature netcdf variable name */
  static const char* DEW_TEMP_IQR25;

  /** @brief 75th percentile dew temperature netcdf variable name */
  static const char* DEW_TEMP_IQR75;
  ...
  /** @brief 25th percentile heading netcdf variable name */
  static const char* HEADING_IQR25;

  /** @brief 75th percentile heading netcdf variable name */
  static const char* HEADING_IQR75;
  ...
  /** @brief 25th percentile horizontal lateral acceleration netcdf variable name */
  static const char* LAT_ACCEL_IQR25;

  /** @brief 75th percentile horizontal lateral acceleration netcdf variable name */
  static const char* LAT_ACCEL_IQR75;
  ...
  /** @brief 25th percentile horizontal longitudinal acceleration netcdf variable name */
  static const char* LON_ACCEL_IQR25;

  /** @brief 75th percentile horizontal longitudinal acceleration netcdf variable name */
  static const char* LON_ACCEL_IQR75;
  ...
  /** @brief 25th percentile yaw rate netcdf variable name */
  static const char* YAW_IQR25;

  /** @brief 75th percentile yaw rate netcdf variable name */
  static const char* YAW_IQR75;
  ...
  /** @brief 25th percentile steering angle netcdf variable name */
  static const char* STEERING_ANGLE_IQR25;

  /** @brief 75th percentile steering angle netcdf variable name */
  static const char* STEERING_ANGLE_IQR75;
  ...
  /** @brief 25th percentile speed netcdf variable name */
  static const char* SPEED_IQR25;

  /** @brief 75th percentile speed netcdf variable name */
  static const char* SPEED_IQR75;
  ...
  /** @brief 25th percentile surface temperature netcdf variable name */
  static const char* SURFACE_TEMP_IQR25;

  /** @brief 75th percentile surface temperature netcdf variable name */
  static const char* SURFACE_TEMP_IQR75;
   ...
   */
  vdt_probe_message_qc_statistics_file_writer(const char* fpath, const char* cdl);
  ~vdt_probe_message_qc_statistics_file_writer();
   ...
   */
  int write_probe_message_qc_statistics(vector<vdt_probe_message_qc_statistics>& stats);

};

#endif /* VDT_PROBE_MESSAGE_QC_STATISTICS_FILE_WRITER_HH */

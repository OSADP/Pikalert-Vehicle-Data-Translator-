...
log_base = "%s/%s" % (vii_paths.LOG_DIR, "run_rwh_mi")

config_file = "%s/%s" % (vii_paths.CONFIG_DIR, "rwh_config.cfg")
fcst_road_seg_file = "%s/%s" % (vii_paths.SITE_LIST_DIR, "MI_logicast_road_sites.asc")
vdt_road_seg_file = "%s/%s" % (vii_paths.CDL_DIR, "mi_roads.20140613.nc")
state = "mi"
fcst_hours_out = 72

...
#       All rights reserved.                                                     #
#                                                                                #
#       File: $RCSfile: run_create_probe_msg_history_mi.py,v $                                           #
#       Version: $Revision: 1.2 $  Dated: $Date: 2014/04/22 21:45:58 $           #
#                                                                                #
# ============================================================================== #
...
def main():
    ...
    cmd = "create_probe_msg_history.py -l /d2/vii/data/log/create_probe_msg_history_mi vii_config /d2/vii/data/processed/mi_vdt_output/ /d2/vii/data/mi_history/ -b %s -e %s" % (begin_time, end_time)

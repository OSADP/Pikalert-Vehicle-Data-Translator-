...
#       All rights reserved.                                                     #
#                                                                                #
#       File: $RCSfile: run_create_probe_msg_history_nv.py,v $                                           #
...
def main():
    ...
    cmd = "create_probe_msg_history.py -l /d2/vii/data/log/create_probe_msg_history_nv vii_config /d2/vii/data/processed/nv_vdt_output/ /d2/vii/data/nv_history/ -b %s -e %s" % (begin_time, end_time)

...
arguments::arguments(int argc, char **argv)
{
  ...
  while ((c = getopt(argc, argv, "a:d:l:n:s:r:w:t")) != EOF)
    {
      switch (c)
        {
        case 'a':
...
{
  fprintf(stderr, "usage: %s [-w road_wx_fcst_file] [-r road_cond_fcst_file] [-s vdt_seg_stats_file] [-a vdt_seg_assign_wx_file] [-l log_file] [-d debug_level] [-t] config_file begin_time_string end_time_string fcst_road_seg_site_list_file vdt_road_seg_file rwh_output_file \n", program_name);

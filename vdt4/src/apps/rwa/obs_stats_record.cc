...
const std::string obs_stats_record::model_bar_press_string = "model_bar_press";
const std::string obs_stats_record::nss_air_temp_mean_string = "nss_air_temp_mean";
const std::string obs_stats_record::nss_bar_press_mean_string = "nss_bar_press_mean";

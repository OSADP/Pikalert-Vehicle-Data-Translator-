/**
 * Travel Time List controller -- handle travel time-related data and actions
 *   This is a COPY of the TravelTimeController -- for managing the list view of travel times.
 * @author paddy
 */
Ext.define('emdss.controller.TravelTimeListController', {
    ...
    config:{
        refs:{
            ...
            ttNavView: 'main navigationview[id=travel-time-list-list]',
            mapView: 'main map',
            listItemVehicles: '#vehicle-list-item',
            listTraveltimes: '#travel-time-list-list-item',
            selectfieldDepartureTime: 'main selectfield[id=departure-time-list-select]'
        },
        control: {
            'listItemVehicles': {
    ...
    init: function() {
        ...
        this.wbTTSegs = Ext.create("emdss.store.TravelTimeSegmentStore",{
            storeId:"wb-travel-time-segment-list-store"
        });
        ...
        // Travel Times
        //
        this.travelTimes = Ext.create("emdss.store.TravelTimeListStore",{
            storeId:"travel-time-list-store"
        });
        console.log("Done creating TravelTime List Store...");
        ...
        this.travelTimes.getProxy().addListener('exception', function (proxy, response, operation) {
                                                                ...
                                                                appController.travelTimesListAttemptedLoad = true;
                                                                appController.travelTimesListLoadFailed = true;
    ...
    onTravelTimesLoad: function(store, data, eOpts) {
        ...
        var appController = emdss.app.getController('emdss.controller.Application');
        if ( !appController.travelTimesListAttemptedLoad ) {
            appController.travelTimesListAttemptedLoad = true;
            appController.travelTimesListLoadFailed = false;
            appController.checkLoadmaskDisable();
        }
    },
    ...
    refreshDepartureTimes: function(travelTimeStore) {
        ...
        var fromSegmentStore = Ext.getStore('wb-travel-time-segment-list-store');
    ...
    onDepartureTimeChange: function( selectfield, newValue, oldValue, eOpts ) {
        ...
        console.log("");
        console.log("");
        console.log("Departure time list changed on LIST controller");
        console.log("");
        console.log("");
        console.log("");
        console.log("");
        ...
        // var fromSegmentStore = Ext.getStore('wb-travel-time-segment-list-store');
        travelTimeStore.previousSelectedDepartureTime = oldValue;
        travelTimeStore.selectedDepartureTime = newValue;
        // fromSegmentStore.recalcAggregateTable(travelTimeStore);
        travelTimeStore.fireEvent('refresh', travelTimeStore, travelTimeStore.getData());
    },

...
Ext.define("emdss.util.Config", {
	...
	watchWarnsUrl: 'http://www.ral.ucar.edu/projects/rdwx_mdss/AK_mdss/proxy_cdot.php?path=/noaa_watch_warnings/',
    ...
    getHrefState: function() {
    	...
    	if (state == undefined || state == null) {
    	    ...
    	    if ( window.location.href.indexOf('?') >= 0 ) {
				...
				console.log("No args provided in the application url. Defaulting to minnesota");
				state = 'minnesota';
		    }

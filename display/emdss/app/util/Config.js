...
Ext.define("emdss.util.Config", {
	...
	watchWarnsUrl: 'http://dot.rap.ucar.edu/noaa_watch_warnings?path=/noaa_watch_warnings/',
        travelTimesUrl: 'http://dot.rap.ucar.edu/latest_travel_time?path=/latest_travel_time/',
        districtAlertLoadTimeout: 180000,
	...
	defaultLocationLookup: {
	    'alaska':    { defaultCenter: new google.maps.LatLng(60.36,-149.96), defaultZoom: 8 },

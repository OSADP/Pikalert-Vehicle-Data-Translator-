...
Ext.application({
    ...
    views: ['Main'],
    models:['Site', 'SitePlots', 'SiteData', 'Vehicle', 'WxWatchWarn', 'Segment' ],
    stores:['SitePlots', 'SiteData', 'DistrictSiteStore', 'DistrictVehicleStore', 'TreatmentExplanations', 'WxWatchWarns', 'Segments' ],

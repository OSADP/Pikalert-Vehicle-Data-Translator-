...
Ext.define("emdss.util.Config", {
	...
	// // RAL Production
	// forceSourceDomain: 'cdot.rap.ucar.edu',
	// districtAlertsUrl:'http://cdot.rap.ucar.edu/district_alerts?path=/district_alerts',
	// districtVehiclesUrl:'http://cdot.rap.ucar.edu/districtvehicles?path=/districtvehicles',
	// plotsUrl:'http://cdot.rap.ucar.edu/plots?path=/plots',
	// radarImagesUrl:'http://cdot.rap.ucar.edu/radar_images?path=/radar_images/',
	// dataTimesUrl:'http://cdot.rap.ucar.edu/datatime?path=/datatime/',
	// vehiclesUrl: 'http://cdot.rap.ucar.edu/latest_vehicles?path=/latest_vehicles/',
	// watchWarnsUrl: 'http://cdot.rap.ucar.edu/noaa_watch_warnings?path=/noaa_watch_warnings/',

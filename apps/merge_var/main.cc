...
extern int merge_data(double forc_gen_time, char *site_list_file,
		      char *cdl_file, char *input_file1, 
		      char *input_file2, char *output_file);
...
{
  fprintf(stderr, "usage:  %s forecast_gen_time site_list cdl_file input_file_1 input_file_2 output_file [-d debug_level] [-l log_file]\n", prog_string);
  exit(2);
}
...
int main(int argc, char **argv)
{
  ...
  ret = merge_data(forc_gen_time, argv[2], argv[3], argv[4], argv[5], argv[6]);

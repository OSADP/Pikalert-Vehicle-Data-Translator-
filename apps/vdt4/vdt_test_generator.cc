...
void vdt_test_generator::get_history_probe_messages(vector<vdt_probe_message_qc> &messages)
{
  ...
  vdt_probe_message_qc aspen_message(qc_fields);
  vdt_probe_message_qc estes_message(qc_fields);
  vdt_probe_message_qc steamboat_message(qc_fields);
...
{
  //Dynamically add new fields
  FIELD_NAME_TYPE_VEC fields;
  filter_vars_by_test(cfg_reader, var_test::MET_FIELD_KEY, fields);
  
  vdt_probe_message null_test_message(fields);
  vdt_probe_message test_too_low_message(fields);
  vdt_probe_message test_low_message(fields);
  vdt_probe_message test_mid_message(fields);
  vdt_probe_message test_high_message(fields);
  vdt_probe_message test_too_high_message(fields);
  vdt_probe_message test_message(fields);
  ...
  vdt_probe_message east_boulder_message(fields);
  ...
  // messages for nvt test
  vdt_probe_message east_boulder_message2(fields);
  ...
  // messages for nvt test
  vdt_probe_message east_boulder_message3(fields);
  ...
  // messages for nvt test
  vdt_probe_message east_boulder_message4(fields);
  ...
  vdt_probe_message aspen_message(fields);
  aspen_message.set_obs_time(vdt_test_generator::obs_time);
  aspen_message.set_rec_time(rec_time);
  aspen_message.set_vehicle_id("aspen_persist_fail");
  aspen_message.set_point(aspen_point);
  ...
  vdt_probe_message estes_message(fields);
  estes_message.set_obs_time(vdt_test_generator::obs_time);
  estes_message.set_rec_time(rec_time);
  estes_message.set_vehicle_id("estes_persist_pass");
  estes_message.set_point(estes_point);
  ...
  vdt_probe_message glenwood_message(fields);
...
#ifdef AIR_TEMP3
  glenwood_message.setattr("air_temp3",glenwood_spatial_temp+4);
#endif
  ...
  // current message for passing spatial iqr test
  vdt_probe_message boulder_barnes_message(fields);
...
#ifdef AIR_TEMP3
  boulder_barnes_message.setattr("air_temp3", boulder_barnes_temp+4);
#endif
  ...
  vdt_probe_message steamboat_message(fields);

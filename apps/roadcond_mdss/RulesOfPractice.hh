...
//
// For anti-cing the upper range of temperatures to treat for (degC)
// This value is the same for all chemical types.
//#define P_MAX_TEMP 2.0
#define P_MAX_TEMP 1.5
...
#endif
#ifndef P_ROADT_INRANGE
  extern int P_ROADT_INRANGE;
#endif

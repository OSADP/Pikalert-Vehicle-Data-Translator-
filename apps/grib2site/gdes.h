 ...
 */
/* $Id: gdes.h,v 1.2 2006/02/15 23:07:57 cowie Exp $ */
...
extern "C" gdes* gdt_to_gdes(GRIB2::gribfield *g2fld); /* Make gdes */
...
extern gdes* gdt_to_gdes(GRIB2::gribfield *g2fld); /* Make gdes */
#else
extern gdes* make_gdes( /* grib1* */ );	/* Make a gdes from raw gds or pds */
extern void free_gdes( /* gdes* */ ); /* free a gdes */
extern void print_gdes( /* gdes* */ ); /* print a gdes */

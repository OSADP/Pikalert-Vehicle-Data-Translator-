 ...
 */
/* $Id: levels.h,v 1.3 2013/10/23 18:37:13 dicast Exp $ */
...
extern "C" int level_g21(GRIB2::g2int *ipdtmpl, int *level_flg, int *levels);
...
extern int level_g21(GRIB2::g2int *ipdtmpl, int *level_flg, int *levels);
#else
extern double mblev ( /* int* levels */ );
#define const
extern char* levelname ( /* int level */ );

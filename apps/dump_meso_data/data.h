...
// Max and Min air temperature values (in degrees C)
#define MAX_AIR_T 55.00
#define MIN_AIR_T -70.00

// Max and Min road temperature values (in degrees C)
#define MAX_ROAD_T 60
#define MIN_ROAD_T -60.00
#define MAX_SUBSURFACE_T 50
#define MIN_SUBSURFACE_T -40.00
